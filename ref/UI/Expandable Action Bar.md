...
documentation: "https://beui.dev/components/blocks/expandable-action-bar"
markdown: "https://beui.dev/components/blocks/expandable-action-bar.md"
license: "MIT"
---
...
```bash
npx shadcn@latest add @beui/expandable-action-bar
```
...
- Registry detail: https://beui.dev/r/expandable-action-bar
- Raw source: https://beui.dev/r/expandable-action-bar/raw

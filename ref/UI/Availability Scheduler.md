...
documentation: "https://beui.dev/components/blocks/availability-scheduler"
markdown: "https://beui.dev/components/blocks/availability-scheduler.md"
license: "MIT"
---
...
```bash
npx shadcn@latest add @beui/availability-scheduler
```
...
- Registry detail: https://beui.dev/r/availability-scheduler
- Raw source: https://beui.dev/r/availability-scheduler/raw

...
documentation: "https://beui.dev/components/blocks/swipeable-list"
markdown: "https://beui.dev/components/blocks/swipeable-list.md"
license: "MIT"
---
...
```bash
npx shadcn@latest add @beui/swipeable-list
```
...
- Registry detail: https://beui.dev/r/swipeable-list
- Raw source: https://beui.dev/r/swipeable-list/raw

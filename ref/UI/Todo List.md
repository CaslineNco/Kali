...
documentation: "https://beui.dev/components/agents/todo-list"
markdown: "https://beui.dev/components/agents/todo-list.md"
license: "MIT"
---
...
```bash
npx shadcn@latest add @beui/todo-list
```
...
- Registry detail: https://beui.dev/r/todo-list
- Raw source: https://beui.dev/r/todo-list/raw
